                    ...
                    <div class="box-body">
                            <div class="form-group" style="margin-top: 10px">
                                    ...
                                    <select name="cat_id" class="form-control">
                                        ...
                                        <?php menuMulti ($cate,0,$str="—", $data->cat_id) ?>
                                    </select>
                                    <!-- /.form-group -->
                            </div>
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="name" placeholder="title" value="{{$data->name}}" required="">
                                </div>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control" name="intro" placeholder="Intro" value="{{$data->intro}}" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="summary-ckeditor" name="content">{!! $data->content !!}</textarea>
