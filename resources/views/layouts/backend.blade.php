...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="hold-transition {{ config('adminlte.theme') }} sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>@yield('controller')<small>@yield('action')</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="http://blog.test/admin"><i class="fa fa-dashboard"></i>Admin</a></li>
        ...
        <script src="{{asset('axios-master/dist/axios.min.js ')}}"></script>
