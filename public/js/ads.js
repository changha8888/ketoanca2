...
bFLeft.attr("style", "float: left; position: fixed; top: 20px; right: " + right_Positiion + "px;");
bFRight.attr("style", "float: right; position: fixed; top: 20px; left: " + left_Positiion + "px;");
